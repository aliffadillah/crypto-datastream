<template>
  <header class="bg-white border-b border-gray-200 sticky top-0 z-50 backdrop-blur-sm shadow-sm">
    <div class="container mx-auto px-6 max-w-[1800px]">
      ...
      <div class="flex items-center justify-between h-20">
        ...
        <div class="flex items-center gap-3">
          ...
          <button
            ...
            class="flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary-dark text-white rounded-lg transition-all duration-200 disabled:opacity-50 font-semibold"
            title="Refresh data"
          >
            <svg 
          ...
          <!-- Market Status -->
          <div class="hidden md:flex items-center gap-2 px-4 py-2.5 bg-success/10 rounded-lg border border-success/20">
            <div class="w-2 h-2 bg-success rounded-full animate-pulse"></div>
      ...
      <!-- Navigation Tabs -->
      <nav class="flex items-center gap-1 border-t border-gray-200 py-2">
        <NuxtLink 
          to="/" 
          class="relative px-6 py-3 text-sm font-semibold transition-all duration-200 rounded-lg"
          :class="$route.path === '/' 
